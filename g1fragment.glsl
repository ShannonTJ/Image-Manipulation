...
void main(void)
{
    ...
    //GRAYSCALE 1
    colour.r = (colour.r*0.333f) + (colour.g*0.333f) + (colour.b*0.333f);
    colour.g = (saveR*0.333f) + (colour.g*0.333f) + (colour.b*0.333f);
    colour.b = (saveR*0.333f) + (saveG*0.333f) + (colour.b*0.333f);
