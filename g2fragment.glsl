...
//GRAYSCALE 2
    colour.r = (colour.r*0.299f) + (colour.g*0.587f) + (colour.b*0.114f);
    colour.g = (saveR*0.299f) + (colour.g*0.587f) + (colour.b*0.114f);
    colour.b = (saveR*0.299f) + (saveG*0.587f) + (colour.b*0.114f);
